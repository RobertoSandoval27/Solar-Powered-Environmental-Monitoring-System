...
// Fan threshold settings in Fahrenheit
float fanOnTempF = 85.0;
float fanOffTempF = 80.0;

// Occupancy estimation settings
unsigned long occupancyTimeoutMs = 300000; // 5 minutes
...
String getOccupancyStatus() {
  ...
  if (currentTime - lastMotionTime <= occupancyTimeoutMs) {
...
String getLastMotionString() {
  ...
  unsigned long elapsedMs = millis() - lastMotionTime;
